...
Welcome to **Solana-Visibilit--des-fonctions**! This application helps you understand the visibility of functions in smart contracts on the Solana blockchain. It is particularly useful for those who are familiar with Ethereum and Solidity. 
...
- **Operating Systems:** Windows 10 or later, macOS 10.14 or later, Ubuntu 20.04 or later.
- **RAM:** At least 4 GB.
...
- **Function Visibility Insights:** Learn how function visibility affects security and accessibility of your smart contracts.
- **Rich Documentation:** Access tutorials and guides within the application.
- **Multi-Platform Support:** Works across Windows, Mac, and Linux.

## 📖 How to Use the Application

1. **Launch the Application:** Find the downloaded file and double-click to open it.
2. **Explore the Dashboard:** The main dashboard provides quick access to various features.
3. **Access Tutorials:** Click on “Tutorials” to start learning about function visibility.
4. **Build and Test:** Use the built-in tools to write and test your smart contracts safely.
